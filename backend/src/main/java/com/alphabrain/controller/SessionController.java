...
public class SessionController {
    ...
    public ResponseEntity<Session> updateSessionStatus(
        ...
        SessionStatus status = SessionStatus.valueOf(statusUpdate.get("status"));
    ...
    public ResponseEntity<Session> updateSessionProgress(
        ...
        String notes = progressUpdate.containsKey("notes") ? progressUpdate.get("notes").toString() : null;
